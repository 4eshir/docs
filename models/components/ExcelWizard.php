...
class ExcelWizard
{
    ...
    */
    ...
    static public function GetDetailPrizeWinners($event_level, $branch_id, $start_date, $end_date)
    {
        ...
        return ParticipantAchievementWork::find()->where(['IN', 'teacher_participant_id', $tpIds])->all();
    }
    ...
    static public function NewGetPrizeWinners($event_level, $branch_id, $start_date, $end_date)
    {
        ...
        $prizes = ParticipantAchievementWork::find()
            ->where(['IN', 'teacher_participant_id', $tpIds])
            ->andWhere(['OR',
                ['NOT IN', 'team_name_id', $tnIds],
                ['IS', 'team_name_id', null]
    ...
    */
    ...
    static public function DownloadEffectiveContract($start_date, $end_date, $budget)
    {
        ...
        for ($i = 0; $i < count($newResult); $i++)
        {
            ...
            $inputData->getSheet(2)->setCellValueByColumnAndRow(2, 5 + $i, $newResult[$i]->teacherParticipantWork->foreignEventWork->eventLevel->name);
            $inputData->getSheet(2)->setCellValueByColumnAndRow(3, 5 + $i, $newResult[$i]->teacherParticipantWork->foreignEventWork->name);
