...
class DocumentOut extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['applicationFiles'], 'file', 'skipOnEmpty' => true, 'extensions' => 'xls, xlsx, png, jpg, pdf, doc, docx', 'maxFiles' => 10],
    ...
    public function afterSave($insert, $changedAttributes)
    {
        ...
        if ($this->isAnswer !== "")
        {
            $inoutdocs = InOutDocs::find()->where(['document_in_id' => $this->isAnswer])->one();
            if ($inoutdocs !== null)
            {
