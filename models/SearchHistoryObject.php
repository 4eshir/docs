 ...
 */
class SearchHistoryObject extends HistoryObject
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'material_object_id', 'count', 'container_id', 'history_transaction_id'], 'integer'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'history_transaction_id' => $this->history_transaction_id,
        ]);
