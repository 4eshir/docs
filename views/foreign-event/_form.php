                    ...
                    <div class="item1 panel panel-default" style="padding: 0; margin: 0"><!-- widgetBody -->
                        <div class="panel-heading" style="padding: 0; margin: 0">
                            ...
                            <div class="col-xs-6">
                                ...
                                $partsTeam = \app\models\work\TeamWork::find()->joinWith('teacherParticipant teacherParticipant')->where(['teacherParticipant.foreign_event_id' => $model->id])->andWhere(['NOT','team_name_id', null])/*->groupBy(['team_name_id'])*/->all();
